                ...
                <form action="edit.php" method="post">
                    <input name="id" value="<?=$id;?>" type="hidden">
                        ...
                        <div class="col">
                            ...
                            <input  name="mail" value="<?=$email ?>" type="email" readonly class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder='Введите вашу почту'>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            <label for="exampleInputPassword1" class="form-label">Повторить пароля</label>
