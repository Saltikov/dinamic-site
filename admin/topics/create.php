        ...
        <div class='posts col-9'>
            ...
            <div class="mb-12 col-12 col-md-12 err">
                ...
                <form action="create.php" method="post">
                        <div class="col">
                            <input name="name" valeu="<?name;?>" type="text" class="form-control" placeholder="Имя категории" aria-label="Имя категории">
                        </div>
                        <div class="col">
                            <label for="content" class="form-label">Описание категории</label>
                            <textarea name="description" class="form-control" id="contetn" rows="3"><?=$description; ?></textarea>
                        </div>
                         <div class="col">
